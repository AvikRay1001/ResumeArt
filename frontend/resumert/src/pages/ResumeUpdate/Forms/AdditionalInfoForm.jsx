    ...
    <div className='px-5 pt-5'>
        ...
        <div className='mt-6'>
            ...
            <div className='flex flex-col gap-4'>
                    ...
                    >
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 items-start'>
                            <Input
                                ...
                                value={lang.language || ""}
                                onChange={({target}) => updateArrayItem(index, "language", target.value)}
                            />

                            <div>
                                <label className='text-xs font-medium text-slate-600 mv-7 block'>
                                    Proficiency
                                </label>
                                <RatingInput
                ...
                <button
                    type="button"
                    className='self-start flex items-center gap-2 px-4 py-2 rounded bg-blue-100 text-blue-800 text-sm font-medium hover:bg-purple-200 cursor-pointer'
                ...
                {interests.map((interest, index) => (
                    ...
                    >
                        <Input
                            ...
                            value={interest || ""}
                            onChange={({target}) => updateArrayItem("interest", index, null, target.value)}
                        />
